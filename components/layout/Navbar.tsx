      ...
      <div className="flex items-center gap-2 md:gap-4">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="ghost" className="relative flex items-center gap-2 px-2 hover:bg-muted/50 transition-colors">
              ...
              <div className="hidden flex-col items-start text-right sm:flex">
                <span className="text-sm font-semibold leading-none">أحمد محمد</span>
